...
function postSetConnectionStatus(connected){if(!connected){$('body').addClass("disconnected");if(!callHomePollInitSequenceComplete){callHomePollInitSequenceComplete=true;$('#loading_orders_spinner').hide();}}else{$('body').removeClass("connected");}}
