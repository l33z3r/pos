...
function makeSumupPayment(amount){if(inAndroidWrapper()){clueyAndroidJSInterface.chargeWithSumup(amount);}}
function printReceiptRemote(remoteHostname,receiptContentJSON){if(inAndroidWrapper()){clueyAndroidJSInterface.printReceiptRemote(remoteHostname,receiptContentJSON);}}