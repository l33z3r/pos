...
function addGlancesTerminalFilter(terminal_id){terminalId=terminal_id;setGlancesParams();}
...
function setDateParams(set_date,isManual){$('#date_from').val(set_date.split(',')[0]);$('#date_to').val(set_date.split(',')[1]);selectedFromDate=set_date.split(',')[0];selectedToDate=set_date.split(',')[1];}
function updateDateParams(set_date,date_type){var olddate=new Date(set_date.replace(/-/g,"/"));var subbed=new Date(olddate-1*60*60*1000);var newtime=subbed.getFullYear()+"-"+(parseInt(subbed.getMonth())+1)+"-"+subbed.getDate()+" "+subbed.getHours()+":"+subbed.getMinutes()
...
function setGlancesParams(){select_type=''
$.ajax({type:'GET',url:'/reports/glances/set_params',data:{"search[search_type]":search_type,"search[terminal]":terminalId}});}
...
function setStockSearchType(interval_selected){switch(interval_selected){case'0':search_type='all';break;case'1':search_type='by_product';$('#string_search_box').hide();$('#to_date').show();$('#from_date').show();$('#date_select').show();break;case'2':search_type='by_category';$('#string_search_box').hide();$('#to_date').show();$('#from_date').show();$('#date_select').show();break;case'3':search_type='by_delivery';$('#string_search_box').show();$('#to_date').show();$('#from_date').show();$('#date_select').show();break;case'4':search_type='by_valuation';$('#string_search_box').hide();$('#to_date').hide();$('#from_date').hide();$('#date_select').hide();break;}
setStockParams();}
...
function setStockSearchTerm(drop_type){$('#category_id_equals').val('Any')
$('#product_id_equals').val('Any')
if(drop_type==''){$.ajax({type:'GET',url:'/reports/stocks/load_dropdown',data:{"search[search_delivery]":$('#delivery_search').val(),"search[dropdown_type]":'',"search[dropdown_id]":''}});}}
function setGlancesSearchType(interval_selected){switch(interval_selected){case'0':search_type='today';break;}
switch(interval_selected){case'1':search_type='yesterday';break;}
switch(interval_selected){case'2':search_type='this_week';break;}
switch(interval_selected){case'3':search_type='last_week';break;}
setGlancesParams();};function setSearchType(interval_selected){switch(interval_selected){case'0':search_type='full_report';$('#product_dropdown').hide();$('#product_search').val('');$('#string_search_box').hide();break;case'1':search_type='best_seller';$('#product_dropdown').hide();$('#product_search').val('');$('#string_search_box').hide();break;case'2':search_type='worst_seller';$('#product_dropdown').hide();$('#product_search').val('');$('#string_search_box').hide();break;case'3':search_type='day';$('#product_dropdown').show();$('#string_search_box').show();break;case'4':search_type='week';$('#product_dropdown').show();$('#string_search_box').show();break;case'5':search_type='month';$('#product_dropdown').show();$('#string_search_box').show();break;case'6':search_type='year';$('#product_dropdown').show();$('#string_search_box').show();break;case'7':search_type='by_product';$('#product_dropdown').hide();$('#product_search').val('');$('#string_search_box').hide();break;case'8':search_type='by_category';$('#product_dropdown').hide();$('#product_search').val('');$('#string_search_box').hide();break;}
setReportParams();}
function setSearchSelect(set_type){if(set_type==-1){$('#sales_items_graph').hide();$('#search_type_select').attr('selectedIndex',0);$('#date_preselect').attr('selectedIndex',10);$('#category_id_equals').attr('selectedIndex',0);$('#product_id_equals').attr('selectedIndex',0);search_type='full_report';setDateParams($('#date_preselect').val(),false);select_type=set_type}
if(set_type==0){$('#search_type_select').attr('selectedIndex',3);$('#date_preselect').attr('selectedIndex',2);search_type='day';setDateParams($('#date_preselect').val(),false);select_type=set_type}
if(set_type==1){$('#search_type_select').attr('selectedIndex',1);$('#date_preselect').attr('selectedIndex',3);search_type='best_seller';setDateParams($('#date_preselect').val(),false);select_type=set_type}
if(set_type==2){$('#search_type_select').attr('selectedIndex',5);$('#date_preselect').attr('selectedIndex',4);search_type='month';setDateParams($('#date_preselect').val(),false);select_type=set_type}
if(set_type==3){$('#search_type_select').attr('selectedIndex',7);$('#date_preselect').attr('selectedIndex',2);search_type='best_seller';setDateParams($('#date_preselect').val(),false);select_type=set_type}
$.ajax({type:'GET',url:'/reports/sales/set_params',data:{"search[search_type]":search_type,"search[category]":$('#category_id_equals').val(),"search[product]":$('#product_id_equals').val(),"search[from_date]":selectedFromDate,"search[to_date]":selectedToDate,"search[terminal]":terminalId,"search[select_type]":select_type,"search[training_mode]":inTrainingMode}}).done(function(){runSalesSearch();});}
function setStockSelect(set_type){if(set_type==-1){$('#string_search_box').hide();$('#to_date').show();$('#from_date').show();$('#date_select').show();$('#sales_items_graph').hide();$('#search_type_select').attr('selectedIndex',0);$('#date_preselect').attr('selectedIndex',0);$('#category_id_equals').attr('selectedIndex',0);$('#category_id_equals').attr('selectedIndex',0);$('#product_id_equals').attr('selectedIndex',0);search_type='best_seller';setDateParams($('#date_preselect').val(),false);select_type=set_type}
...
function updatePaymentDateParams(set_date,date_type){var olddate=new Date(set_date.replace(/-/g,"/"));var subbed=new Date(olddate-1*60*60*1000);var newtime=subbed.getFullYear()+"-"+(parseInt(subbed.getMonth())+1)+"-"+subbed.getDate()+" "+subbed.getHours()+":"+subbed.getMinutes()
if(date_type=='from'){selectedFromDate=newtime;}else{selectedToDate=newtime;}}
$(function(){setReportsDatePickers();});var selectedFromDate;var selectedToDate;var search_type;var terminalId;var hour_from;var hour_to;var drop_val;var discounts_only=false;var drop_set_type;var select_type='';function setPaymentReportsDatePickers(){$('#date_select_container').find('#date_from').datetimepicker({dateFormat:'yy-mm-dd',defaultDate:'01/01/01',timeFormat:'h:m',addSliderAccess:true,sliderAccessArgs:{touchonly:false}});$('#date_select_container').find('#date_to').datetimepicker({dateFormat:'yy-mm-dd',defaultDate:'01/01/01',timeFormat:'h:m',addSliderAccess:true,sliderAccessArgs:{touchonly:false}});}
var TODAY="1"
var YESTERDAY="2"
...
function updateStaffDateParams(set_date,date_type){var olddate=new Date(set_date.replace(/-/g,"/"));var subbed=new Date(olddate-1*60*60*1000);var newtime=subbed.getFullYear()+"-"+(parseInt(subbed.getMonth())+1)+"-"+subbed.getDate()+" "+subbed.getHours()+":"+subbed.getMinutes()
if(date_type=='from'){selectedFromDate=newtime;}else{selectedToDate=newtime;}}
...
function updateCustomerDateParams(set_date,date_type){var olddate=new Date(set_date.replace(/-/g,"/"));var subbed=new Date(olddate);var newtime=subbed.getFullYear()+"-"+(parseInt(subbed.getMonth())+1)+"-"+subbed.getDate()+" "+subbed.getHours()+":"+subbed.getMinutes()
if(date_type=='from'){selectedFromDate=newtime;}else{selectedToDate=newtime;}}