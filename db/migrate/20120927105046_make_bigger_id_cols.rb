class MakeBiggerIdCols < ActiveRecord::Migration
  def self.up
    execute("ALTER TABLE products MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE outlet_terminals MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE outlet_terminals MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE cluey_accounts MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    
    execute("ALTER TABLE displays MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE displays MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE menu_pages MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE menu_items MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE global_settings MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE global_settings MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE card_transactions MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE cash_outs MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE cash_outs MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE cash_out_presets MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE cash_out_presets MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE cash_totals MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE categories MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE client_transactions MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE customer_points_allocations MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE customer_transactions MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE deliveries MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE discounts MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE discounts MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE display_buttons MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE display_button_groups MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE display_button_groups MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE display_button_roles MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE display_button_roles MODIFY column display_button_id BIGINT")
    execute("ALTER TABLE display_button_roles MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE employees MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE employees MODIFY column role_id BIGINT")
    execute("ALTER TABLE employees MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE ingredients MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE loyalty_levels MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE loyalty_levels MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE modifiers MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE modifier_categories MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE modifier_categories MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE orders MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE order_items MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE order_item_addition_grids MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE order_item_addition_grids MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE printers MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE printers MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE order_item_additions MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE payments MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE payment_methods MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE receipt_footers MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE receipt_footers MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE roles MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE roles MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE rooms MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE rooms MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE room_objects MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE shift_timestamps MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE stock_transactions MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE stored_receipt_htmls MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE stored_receipt_htmls MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE table_infos MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE tax_rates MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE tax_rates MODIFY column outlet_id BIGINT")
    
    execute("ALTER TABLE terminal_display_links MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    ...
    execute("ALTER TABLE terminal_sync_data MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
    execute("ALTER TABLE terminal_sync_data MODIFY column outlet_id BIGINT")

    execute("ALTER TABLE work_reports MODIFY column id BIGINT NOT NULL AUTO_INCREMENT")
